...
export function CreateInternalInvoice({ show, closeModal }: ModalProps) {
  ...
  return (
    <Modal show={show} closeModal={closeModal}>
      <div className="fixed left-1/2 h-svh w-dvw max-w-[520px] -translate-x-1/2 overflow-y-auto rounded-none bg-white p-4 md:top-1/2 md:max-h-[90dvh] md:w-[90%] md:-translate-y-1/2 md:rounded-2xl md:py-8">
