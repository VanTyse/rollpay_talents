          ...
          <div className="mx-auto w-full lg:max-w-[360px]">
            ...
            <form onClick={(e) => e.preventDefault()}>
              <fieldset className="mb-5 lg:mb-4">
                <TextInput label={"Email"} id="signup-email" required />
              </fieldset>
              <fieldset className="mb-5 lg:mb-4">
                <TextInput label={"Phone Number"} id="signup-phone" required />
              </fieldset>
              <fieldset className="mb-5 lg:mb-4">
                <TextInput
                  label={"First Name"}
              ...
              <fieldset className="mb-6">
                <TextInput label={"Last Name"} id="signup-last-name" required />
              </fieldset>
              <Button
                variant="primary"
